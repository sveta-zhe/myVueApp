let app = new Vue({
    ...
    endGame() {
      ...
      // Зерг
      if(this.score.zerg > this.score.protoss && this.score.zerg > this.score.terran && this.score.primal < 8 && Math.abc(this.score.protoss - this.score.zerg) > 3) {
      ...
      // Протосс
        ...
        this.score.taldarim < 5 && Math.abc(this.score.protoss - this.score.zerg) > 3) {
    ...
    // Талдарим
       ...
       // Гибрид
      else if (Math.abc(this.score.protoss - this.score.zerg) <= 3) {
